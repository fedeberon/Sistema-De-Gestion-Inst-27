...
public class Verificador {
    ...
    //==================================================================================================================
    private boolean chequearEspacios (String text, boolean nullable){
        /*-En caso de que el string acepte espacios, verifica que no se componga solo de ellos
    ...
    public boolean chequearTexto(String text, boolean nullable){
        /*Verifica que el contenido del campo sea texto puro (sin numeros ni simbolos)*/
